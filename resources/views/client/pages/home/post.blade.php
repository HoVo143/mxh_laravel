...
<div class="post-container">
    ...
    <div class="post-img">
        <div class="container-img">
            ...
            <div class="row1">
              <div class="column1">
                <img class="demo1 cursor" src="{{asset('img/ho_vo.jpg')}}" style="width:100%" onclick="currentSlideImg(1)" alt="The Woods">
              </div>
              <div class="column1">
                <img class="demo1 cursor" src="{{asset('img/web-developer.jpg')}}" style="width:100%" onclick="currentSlideImg(2)" alt="Cinque Terre">
              </div>
              <div class="column1">
                <img class="demo1 cursor" src="{{asset('img/hoa.jpg')}}" style="width:100%" onclick="currentSlideImg(3)" alt="Mountains and fjords">
              </div>
              <div class="column1">
                <img class="demo1 cursor" src="{{asset('img/hoa.jpg')}}" style="width:100%" onclick="currentSlideImg(3)" alt="Mountains and fjords">
              </div>
              ...
              <div class="column1 full" onclick="document.getElementById('section-cmt').style.display='block'">
                    <div class="full-icon">
                        <i class="fa-solid fa-plus" onclick="document.getElementById('section-cmt').style.display='block'"></i>
                    </div>
              </div>

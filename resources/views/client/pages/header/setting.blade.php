        ...
        <div id="myDiv" class="myDivClass">
            ...
            <div class="wrapper_updatenam">
                <div class="updatename">
                    <h4>Tên: <span>Hồ Võ</span></h4>
                    <button id="showFormButton" data-form-id="myForm">Chỉnh sửa</button>
                </div>
                <div class="updatename">
                    <h4>Email: <span>adadad077@gmail.com</span> </h4>
                </div>
                <div class="updatename">
                    <h4>Số điện thoại: <span>0962876454</span></h4>
                ...
                <form id="myForm" class="hidden form" method="POST">
                    ...
                    <div class="">
                        ...
                        <input type="text" class="fname" placeholder="Tên" name="fname" required>
                        <label for="lname"><b>Họ</b></label>
                        <input type="text" class="lname" placeholder="Họ" name="lname" required>
                ...
                <form id="myFormPhone" class="hidden form" method="POST">
                    ...
                    <div class="">
                        ...
                        <input type="tel" class="phone" placeholder="Nhập số điện thoại mới" name="phone" required
                            pattern="[0-9]{10}">
                        <input type="submit" class="btnsubmit" value="Lưu thay đổi">
                    </div>
                </form>
                ...
                <form id="myFormPass" class="hidden form" method="POST">
                    ...
                    <div class="">
                        ...
                        <input type="password" class="password" placeholder="Nhập mật khẩu cũ" name="psw" required>
                        <span class="error">Sai mật khẩu</span>

                        <label for="psw"><b>Nhập mật khẩu mới</b></label>
                        <input type="password" class="password" placeholder="Nhập mật khẩu mới" name="psw" required>

                        <label for="psw-repeat"><b>Nhập lại mật khẩu mới</b></label>
                        <input type="password" class="password" placeholder="Nhập lại mật khẩu mới" name="psw-repeat"
                            required>
                        <input type="submit" class="btnsubmit" value="Lưu thay đổi">
                    </div>
                </form>
